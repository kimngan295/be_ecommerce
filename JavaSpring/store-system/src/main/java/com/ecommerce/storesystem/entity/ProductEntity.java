...
public class ProductEntity extends BaseEntity {
	...
	public void setProductEntity(ProductDto productDto) {
		...
		this.productWarranty = productDto.getProductWarranty();
		this.quantity = productDto.getQuantity();
		this.ram = productDto.getRam();
		this.rom = productDto.getRom();
		this.screen = productDto.getScreen();
		this.battery = productDto.getBattery();
		this.os = productDto.getOs();
		this.camera = productDto.getCamera();
